...
class CLM(LM):
    def __init__(self, model_name, cache_file, model_dir=None):
    ...
    def load_model(self):
        ...
        if "gemma" in self.model_name:
            self.model = AutoModelForCausalLM.from_pretrained(self.model_dir, device_map="auto", torch_dtype=torch.bfloat16)
